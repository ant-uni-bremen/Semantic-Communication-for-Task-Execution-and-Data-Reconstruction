...
from channel import AWGNLayer,IdentityChannel
                        ...
                        for train_snr in train_snrs:
                            ...
                            for split_image_into in split_image_intos:
                                ...
                                for model in selected_models:
                                    ...
                                    if beta == 0 or loss_function=="mse":
                                        model_path = f'{model.lower()}_model_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                        enc_path = f'{model.lower()}_encoder_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                        dec_path = f'{model.lower()}_decoder_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                    else:
                                        model_path = f'{model.lower()}_model_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_beta_{beta}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                        enc_path = f'{model.lower()}_encoder_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_beta_{beta}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                        dec_path = f'{model.lower()}_decoder_epochs_{epochs}_lr_{initial_learning_rate}_bn_{enc_out_dec_inp}_train_snr_{train_snr}_split_image_into_{split_image_into}_alpha_{alpha}_betaa_{beta}_loss_function_{loss_function}_dataset_{dataset}_baselineClassifier.weights.h5'
                                    if model == "CNN":
